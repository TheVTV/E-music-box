...
**E-Music Box** to elektroniczna pozytywka zbudowana wyłącznie w oparciu o **układy logiki cyfrowej**.
...
```
Zegar > Liczniki > EEPROM > Dekoder > Generator Dźwięku
```
...
- [Opis działania](/report/pl/zarys.md)
- [Schemat końcowy](/report/pl/finalny_uklad.md)
...
```
Clock > Counters > EEPROM > Decoder > Sound Generator
```
